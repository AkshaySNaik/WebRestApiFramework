...
public class TC007_GETavailTest extends BaseClass {
	
	@Test(priority = 1)
	public void GETAvailableTest() {

		log.info("********** Started TC007_GetAvailableDetails **************");

		RestAssured.baseURI = URI;
		httprequest = RestAssured.given();
		response = httprequest.request(Method.GET, "v2/pet/findByStatus?status=available");
	...
	public void checkResponseBody() {
		...
		Assert.assertTrue(responsebody.contains("doggie"));
	}
