...
public class TC005_GETauthdetailsTest extends BaseClass {

	@Test(priority = 1, dataProvider = "data")
	public void GETAuthLoginTest(String getdata) {

		log.info("********** Started TC005_GetAuthTest **************");

		String[] data = getdata.split(",");

		RestAssured.baseURI = URI;
		httprequest = RestAssured.given();
		response = httprequest.request(Method.GET, "v2/user/login?username=" + data[1] + "&password=" + data[3]);
